...
Taxa de imposto a pagar : {metodoPf.PagarImposto(cadaPessoa.rendimento).ToString("C")}
                            ");
Thread.Sleep(5000);
                            ...
                            Console.WriteLine($"Não ha informacoes na lista");
                            Thread.Sleep(3000);
                ...
                switch (opcaoPJ)
                {
                    ...
                    case "2":
                        ...
                        if ( listaPJ.Count > 0 ) {
                            ...
                            foreach (PessoaJuridica cadaJuridica in listaPJ) {
                                Console.Clear();
                                Console.WriteLine(@$"
Nome: {cadaJuridica.nome}
Razao Social: {cadaJuridica.razaoSocial}
Endereco: {cadaJuridica.endereco.logradouro}, {cadaJuridica.endereco.numero}
CNPJ: {cadaJuridica.cnpj}
Taxa de imposto a pagar : {metodoPJ.PagarImposto(cadaJuridica.rendimento).ToString("C")}
                            ");
Thread.Sleep(5000);
